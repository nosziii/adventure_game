...
import { Controller, Post, Body, Request, UseGuards, Logger, ValidationPipe } from '@nestjs/common'; // Szükséges importok
...
export class CharacterController {
    ...
    ): Promise<CharacterStatsDto> { // Adjunk vissza friss statokat
